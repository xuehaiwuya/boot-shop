...
import com.studyinghome.bootshop.util.weixin.WeixinUtil;
...
public class BaiduMap {
     ...
     * 获取点之间的距离
     *
     * @param origins      起点（可以为坐标点或地址名称）
     * @param destinations 终点（最多有5个）
     * @param mode         导航模式 driving和walking，默认为driving
     */
